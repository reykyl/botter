...
do {
let lineM = '⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ 》'
opcion = await question(chalk.bgBlack(chalk.bold.greenBright(`Seleccione Una Opción:\n1. Con Código QR\n2. Con Código De Texto De 8 Dígitos\n---> `)))
if (!/^[1-2]$/.test(opcion)) {
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Luna Bot', 'Edge', '20.0.04'] : methodCodeQR ? ['Sylphiette', 'Edge', '20.0.04'] : ["Ubuntu", "Opera", "20.0.04"],
auth: {
creds: state.creds,
...
do {
phoneNumber = await question(chalk.bgBlack(chalk.bold.greenBright(`Por Favor, Ingrese El Número De WhatsApp.\n${chalk.bold.yellowBright("Copie El Número De WhatsApp Y Péguelo En La Consola.")}\n${chalk.bold.yellowBright("Ejemplo: +51939658716")}\n${chalk.bold.magentaBright('---> ')}`)))
...
let prekey = []
let directorio = readdirSync("./Sesiones/Principal")
...
try {
let listaDirectorios = readdirSync('./Sesiones/Subbots/');
let SBprekey = []
...
console.log(chalk.bold.red(`Algo Salio Mal Durante La Eliminación.`))
}}

function purgeOldFiles() {
const directories = ['./Sesiones/Principal/', './Sesiones/Subbots/']
...
if (reason == 405) {
await fs.unlinkSync("./Sesiones/Principal/" + "creds.json")
