        ...
        case 'remove':
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    let welimg = await (await fetch('https://ibb.co/t5cQsvT')).buffer()
                    let byeimg = await (await fetch('https://ibb.co/t5cQsvT')).buffer()
...
global.dfail = (type, m, conn, usedPrefix) => {
    let msg = {
        ...
        admin: `Hola, este comando solo puede ser utilizado por *Administradores* del Grupo.`,
        botAdmin: `Hola, la bot debe ser *Administradora*.`,
        unreg: `Hola, para usar este comando debes *Registrarte.*`,
